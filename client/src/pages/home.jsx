  ...
  return (
    <div className="login_page flex flex-col justify-evenly items-center">
      <div className="text-white flex flex-col items-center gap-2">
        <h1 className="text-4xl font-semibold">Watch Together.
        <span className="block bg-gradient-to-b from-[#FF5E8A] via-[#FF4D7A] to-[#E63E6D] bg-clip-text text-transparent">Anywhere.</span>
        </h1>
        <h4 className="">
          Create or join a room and enjoy together
        </h4>
      </div>
      ...
      <div className="login_form rounded-3xl w-[30%] h-1/2 flex flex-col justify-evenly items-center text-white ">
        ...
        <div className="flex flex-col items-center">
          ...
          <h4 className="text-m text-gray-400 ">Enter your details to get started</h4>
        </div>
